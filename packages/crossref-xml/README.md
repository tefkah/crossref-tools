...
Generate CrossrefXML purely in Node using a friendly JSON api
...
```sh
yarn add crossref-xml
```

or with [npm](https://docs.npmjs.com/cli/install)

```sh
npm install crossref-xml
```
...
[crossref-xml]: https://github.com/journaloftrialanderror/jote/tree/main/libs/crossref-xml
