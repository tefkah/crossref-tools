...
export const LicenseRefTSchema = XastElementSchema.extend({
    ...
    children: z.tuple([z.object({
             ...
             * @minLength 10
             **/
            value: z.string().min(10).regex(/([hH][tT][tT][pP]|[hH][tT][tT][pP][sS]|[fF][tT][pP]):\/\/.*/)
        })])
});

export const LicenseRefAppliesToSchema = z.union([z.literal("vor"), z.literal("am"), z.literal("tdm"), z.literal("stm-asf")]);
