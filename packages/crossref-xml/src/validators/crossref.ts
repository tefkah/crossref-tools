...
export const ResourceTSchema = XastElementSchema.extend({
    ...
    children: z.tuple([z.object({
             ...
             * @maxLength 2048
             **/
            value: z.string().min(1).max(2048).regex(/([hH][tT][tT][pP]|[hH][tT][tT][pP][sS]|[fF][tT][pP]):\/\/.*/)
        })])
});
...
export const IsbnTSchema = XastElementSchema.extend({
    ...
    children: z.tuple([z.object({
             ...
             * @maxLength 17
             **/
            value: z.string().min(10).max(17).regex(/(97(8|9)-)?\d[\d \-]+[\dX]/)
        })])
});
...
export const IssnTSchema = XastElementSchema.extend({
    ...
    children: z.tuple([z.object({
             ...
             * @maxLength 9
             **/
            value: z.string().min(8).max(9).regex(/\d{4}-?\d{3}[\dX]/)
        })])
});
...
export const BookBookTypeSchema = z.union([z.literal("edited_book"), z.literal("monograph"), z.literal("reference"), z.literal("other")]);
...
export const ContentItemComponentTypeSchema = z.union([z.literal("chapter"), z.literal("section"), z.literal("part"), z.literal("track"), z.literal("reference_entry"), z.literal("other")]);
...
export const ContributorRoleSchema = z.union([z.literal("author"), z.literal("editor"), z.literal("chair"), z.literal("reviewer"), z.literal("review-assistant"), z.literal("stats-reviewer"), z.literal("reviewer-external"), z.literal("reader"), z.literal("translator")]);

export const ItemCountrySchema = z.union([z.literal("AD"), z.literal("AE"), z.literal("AF"), z.literal("AG"), z.literal("AI"), z.literal("AL"), z.literal("AM"), z.literal("AN"), z.literal("AO"), z.literal("AQ"), z.literal("AR"), z.literal("AS"), z.literal("AT"), z.literal("AU"), z.literal("AW"), z.literal("AX"), z.literal("AZ"), z.literal("BA"), z.literal("BB"), z.literal("BD"), z.literal("BE"), z.literal("BF"), z.literal("BG"), z.literal("BH"), z.literal("BI"), z.literal("BJ"), z.literal("BL"), z.literal("BM"), z.literal("BN"), z.literal("BO"), z.literal("BQ"), z.literal("BR"), z.literal("BS"), z.literal("BT"), z.literal("BV"), z.literal("BW"), z.literal("BY"), z.literal("BZ"), z.literal("CA"), z.literal("CC"), z.literal("CD"), z.literal("CF"), z.literal("CG"), z.literal("CH"), z.literal("CI"), z.literal("CK"), z.literal("CL"), z.literal("CM"), z.literal("CN"), z.literal("CO"), z.literal("CR"), z.literal("CS"), z.literal("CU"), z.literal("CV"), z.literal("CX"), z.literal("CY"), z.literal("CZ"), z.literal("DE"), z.literal("DJ"), z.literal("DK"), z.literal("DM"), z.literal("DO"), z.literal("DZ"), z.literal("EC"), z.literal("EE"), z.literal("EG"), z.literal("EH"), z.literal("ER"), z.literal("ES"), z.literal("ET"), z.literal("FI"), z.literal("FJ"), z.literal("FK"), z.literal("FM"), z.literal("FO"), z.literal("FR"), z.literal("GA"), z.literal("GB"), z.literal("GD"), z.literal("GE"), z.literal("GF"), z.literal("GG"), z.literal("GH"), z.literal("GI"), z.literal("GL"), z.literal("GM"), z.literal("GN"), z.literal("GP"), z.literal("GQ"), z.literal("GR"), z.literal("GS"), z.literal("GT"), z.literal("GU"), z.literal("GW"), z.literal("GY"), z.literal("HK"), z.literal("HM"), z.literal("HN"), z.literal("HR"), z.literal("HT"), z.literal("HU"), z.literal("ID"), z.literal("IE"), z.literal("IL"), z.literal("IM"), z.literal("IN"), z.literal("IO"), z.literal("IQ"), z.literal("IR"), z.literal("IS"), z.literal("IT"), z.literal("JE"), z.literal("JM"), z.literal("JO"), z.literal("JP"), z.literal("KE"), z.literal("KG"), z.literal("KH"), z.literal("KI"), z.literal("KM"), z.literal("KN"), z.literal("KP"), z.literal("KR"), z.literal("KW"), z.literal("KY"), z.literal("KZ"), z.literal("LA"), z.literal("LB"), z.literal("LC"), z.literal("LI"), z.literal("LK"), z.literal("LR"), z.literal("LS"), z.literal("LT"), z.literal("LU"), z.literal("LV"), z.literal("LY"), z.literal("MA"), z.literal("MC"), z.literal("MD"), z.literal("ME"), z.literal("MF"), z.literal("MG"), z.literal("MH"), z.literal("MK"), z.literal("ML"), z.literal("MM"), z.literal("MN"), z.literal("MO"), z.literal("MP"), z.literal("MQ"), z.literal("MR"), z.literal("MS"), z.literal("MT"), z.literal("MU"), z.literal("MV"), z.literal("MW"), z.literal("MX"), z.literal("MY"), z.literal("MZ"), z.literal("NA"), z.literal("NC"), z.literal("NE"), z.literal("NF"), z.literal("NG"), z.literal("NI"), z.literal("NL"), z.literal("NO"), z.literal("NP"), z.literal("NR"), z.literal("NU"), z.literal("NZ"), z.literal("OM"), z.literal("PA"), z.literal("PE"), z.literal("PF"), z.literal("PG"), z.literal("PH"), z.literal("PK"), z.literal("PL"), z.literal("PM"), z.literal("PN"), z.literal("PR"), z.literal("PS"), z.literal("PT"), z.literal("PW"), z.literal("PY"), z.literal("QA"), z.literal("RE"), z.literal("RO"), z.literal("RS"), z.literal("RU"), z.literal("RW"), z.literal("SA"), z.literal("SB"), z.literal("SC"), z.literal("SD"), z.literal("SE"), z.literal("SG"), z.literal("SH"), z.literal("SI"), z.literal("SJ"), z.literal("SK"), z.literal("SL"), z.literal("SM"), z.literal("SN"), z.literal("SO"), z.literal("SR"), z.literal("SS"), z.literal("ST"), z.literal("SV"), z.literal("SX"), z.literal("SY"), z.literal("SZ"), z.literal("TC"), z.literal("TD"), z.literal("TF"), z.literal("TG"), z.literal("TH"), z.literal("TJ"), z.literal("TK"), z.literal("TL"), z.literal("TM"), z.literal("TN"), z.literal("TO"), z.literal("TR"), z.literal("TT"), z.literal("TV"), z.literal("TW"), z.literal("TZ"), z.literal("UA"), z.literal("UG"), z.literal("UM"), z.literal("US"), z.literal("UY"), z.literal("UZ"), z.literal("VA"), z.literal("VC"), z.literal("VE"), z.literal("VG"), z.literal("VI"), z.literal("VN"), z.literal("VU"), z.literal("WF"), z.literal("WS"), z.literal("YE"), z.literal("YT"), z.literal("ZA"), z.literal("ZM"), z.literal("ZW")]);

export const ItemCrawlerSchema = z.union([z.literal("google"), z.literal("msn"), z.literal("scirus"), z.literal("yahoo"), z.literal("iParadigms")]);
...
export const CrossmarkPolicySchema = XastElementSchema.extend({
    ...
    children: z.tuple([z.object({
             ...
             * @maxLength 2048
             **/
            value: z.string().min(6).max(2048).regex(/10\.[0-9]{4,9}\/.{1,200}/)
        })])
});
...
export const DatasetDatasetTypeSchema = z.union([z.literal("record"), z.literal("collection"), z.literal("crossmark_policy"), z.literal("other")]);
...
export const DomainSchema = XastElementSchema.extend({
    ...
    children: z.tuple([z.object({
             ...
             * @maxLength 1024
             **/
            value: z.string().min(4).max(1024).regex(/[A-Za-z0-9_]+([-.][A-Za-z0-9_]+)*\.[A-Za-z0-9_]+([-.][A-Za-z0-9_]+)*/)
        })])
});
 ...
 * @maxLength 1024
 **/
export const CmDomainSchema = z.string().min(4).max(1024).regex(/[A-Za-z0-9_]+([-.][A-Za-z0-9_]+)*\.[A-Za-z0-9_]+([-.][A-Za-z0-9_]+)*/);
...
export const EventMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ConferenceAcronymSchema, ConferenceDateSchema, ConferenceLocationSchema, ConferenceNameSchema, ConferenceNumberSchema, ConferenceSponsorSchema, ConferenceThemeSchema]))
});
...
export const GivenNameSchema = XastElementSchema.extend({
    ...
    children: z.tuple([z.object({
             ...
             * @maxLength 60
             **/
            value: z.string().min(1).max(60).regex(/[^\d\?]*[^\?\s]+[^\d]*/)
        })])
});
 ...
 * @maxLength 60
 **/
export const GivenNamePrimitiveTypeSchema = z.string().min(1).max(60).regex(/[^\d\?]*[^\?\s]+[^\d]*/);
...
export const IdentifierIdTypeSchema = z.union([z.literal("pii"), z.literal("sici"), z.literal("doi"), z.literal("dai"), z.literal("Z39.23"), z.literal("ISO-std-ref"), z.literal("std-designation"), z.literal("report-number"), z.literal("pmid"), z.literal("other")]);
...
export const DateTMediaTypeSchema = z.union([z.literal("online"), z.literal("print"), z.literal("other")]);

export const MediaTypeSchema = z.union([z.literal("print"), z.literal("electronic")]);

export const MimeTypeSchema = z.union([z.literal("text/css"), z.literal("text/csv"), z.literal("text/enriched"), z.literal("text/html"), z.literal("text/plain"), z.literal("text/richtext"), z.literal("text/rtf"), z.literal("text/sgml"), z.literal("text/tab-separated-values"), z.literal("text/xml"), z.literal("text/xml-external-parsed-entity"), z.literal("multipart/mixed"), z.literal("multipart/alternative"), z.literal("multipart/digest"), z.literal("multipart/parallel"), z.literal("multipart/appledouble"), z.literal("multipart/header-set"), z.literal("multipart/form-data"), z.literal("multipart/report"), z.literal("multipart/voice-message"), z.literal("multipart/signed"), z.literal("multipart/encrypted"), z.literal("multipart/byteranges"), z.literal("application/eps"), z.literal("application/epub+zip"), z.literal("application/octet-stream"), z.literal("application/postscript"), z.literal("application/rtf"), z.literal("application/applefile"), z.literal("application/mac-binhex40"), z.literal("application/wordperfect5.1"), z.literal("application/pdf"), z.literal("application/x-gzip"), z.literal("application/zip"), z.literal("application/gzip"), z.literal("application/macwriteii"), z.literal("application/msword"), z.literal("application/sgml"), z.literal("application/cals-1840"), z.literal("application/pgp-encrypted"), z.literal("application/pgp-signature"), z.literal("application/pgp-keys"), z.literal("application/sgml-open-catalog"), z.literal("application/rc"), z.literal("application/xml"), z.literal("application/xml-external-parsed-entity"), z.literal("application/xml-dtd"), z.literal("application/batch-SMTP"), z.literal("application/ipp"), z.literal("application/ocsp-request"), z.literal("application/ocsp-response"), z.literal("application/vnd.wolfram.mathematica"), z.literal("application/vnd.wolfram.mathematica.package"), z.literal("application/vnd.wolfram.player"), z.literal("application/vnd.oasis.opendocument.text"), z.literal("application/vnd.oasis.opendocument.presentation"), z.literal("application/vnd.oasis.opendocument.spreadsheet"), z.literal("application/vnd.ms-asf"), z.literal("application/vnd.ms-excel"), z.literal("application/vnd.ms-powerpoint"), z.literal("application/vnd.openxmlformats-officedocument.presentationml.presentation"), z.literal("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"), z.literal("application/vnd.openxmlformats-officedocument.wordprocessingml.document"), z.literal("application/epub+zip"), z.literal("application/regex.clinical-trial-number"), z.literal("image/fits"), z.literal("image/jpeg"), z.literal("image/gif"), z.literal("image/ief"), z.literal("image/g3fax"), z.literal("image/tiff"), z.literal("image/Graphics-Metafile"), z.literal("image/png"), z.literal("audio/basic"), z.literal("audio/32kadpcm"), z.literal("audio/mpeg"), z.literal("audio/parityfec"), z.literal("audio/MP4A-LATM"), z.literal("audio/mpa-robust"), z.literal("video/x-ms-wmv"), z.literal("video/avi"), z.literal("video/mpeg"), z.literal("video/quicktime"), z.literal("video/pointer"), z.literal("video/parityfec"), z.literal("video/MP4V-ES"), z.literal("video/mp4"), z.literal("chemical/x-alchemy"), z.literal("chemical/x-cache-csf"), z.literal("chemical/x-cactvs-binary"), z.literal("chemical/x-cactvs-binary"), z.literal("chemical/x-cactvs-binary"), z.literal("chemical/x-cdx"), z.literal("chemical/x-cerius"), z.literal("chemical/x-chemdraw"), z.literal("chemical/x-cif"), z.literal("chemical/x-mmcif"), z.literal("chemical/x-chem3d"), z.literal("chemical/x-cmdf"), z.literal("chemical/x-compass"), z.literal("chemical/x-crossfire"), z.literal("chemical/x-cml"), z.literal("chemical/x-csml"), z.literal("chemical/x-ctx"), z.literal("chemical/x-cxf"), z.literal("chemical/x-daylight-smiles"), z.literal("chemical/x-embl-dl-nucleotide"), z.literal("chemical/x-galactic-spc"), z.literal("chemical/x-gamess-input"), z.literal("chemical/x-gaussian-input"), z.literal("chemical/x-gaussian-checkpoint"), z.literal("chemical/x-gaussian-cube"), z.literal("chemical/x-gcg8-sequence"), z.literal("chemical/x-genbank"), z.literal("chemical/x-isostar"), z.literal("chemical/x-jcamp-dx"), z.literal("chemical/x-kinemage"), z.literal("chemical/x-macmolecule"), z.literal("chemical/x-macromodel-input"), z.literal("chemical/x-mdl-molfile"), z.literal("chemical/x-mdl-rdfile"), z.literal("chemical/x-mdl-rxnfile"), z.literal("chemical/x-mdl-sdfile"), z.literal("chemical/x-mdl-tgf"), z.literal("chemical/x-mif"), z.literal("chemical/x-mol2"), z.literal("chemical/x-molconn-Z"), z.literal("chemical/x-mopac-input"), z.literal("chemical/x-mopac-graph"), z.literal("chemical/x-ncbi-asn1"), z.literal("chemical/x-ncbi-asn1-binary"), z.literal("chemical/x-pdb"), z.literal("chemical/x-swissprot"), z.literal("chemical/x-vamas-iso14976"), z.literal("chemical/x-vmd"), z.literal("chemical/x-xtel"), z.literal("chemical/x-xyz"), z.literal("model/stl"), z.literal("model/x.stl-binary"), z.literal("model/x.stl-ascii"), z.literal("model/vrml"), z.literal("audio/x-wav"), z.literal("video/x-flv"), z.literal("Data/spcvue.htm")]);
...
export const ArchiveNameSchema = z.union([z.literal("CLOCKSS"), z.literal("LOCKSS"), z.literal("Portico"), z.literal("KB"), z.literal("Internet Archive"), z.literal("DWT")]);
...
export const NameNameStyleSchema = z.union([z.literal("western"), z.literal("eastern"), z.literal("islensk"), z.literal("given-only")]);

export const StringNameNameStyleSchema = z.union([z.literal("western"), z.literal("eastern"), z.literal("islensk"), z.literal("given-only")]);

export const NameStyleSchema = z.union([z.literal("western"), z.literal("eastern"), z.literal("islensk"), z.literal("given-only")]);
...
export const ComponentParentRelationSchema = z.union([z.literal("isPartOf"), z.literal("isReferencedBy"), z.literal("isRequiredBy"), z.literal("isTranslationOf")]);
...
export const CollectionPropertySchema = z.union([z.literal("list-based"), z.literal("country-based"), z.literal("crawler-based"), z.literal("text-mining"), z.literal("unspecified"), z.literal("syndication"), z.literal("link-header")]);
...
export const StandardMetadataPublicationStatusSchema = z.union([z.literal("released"), z.literal("withdrawn")]);

export const PublicationTypeSchema = z.union([z.literal("abstract_only"), z.literal("full_text"), z.literal("bibliographic_record")]);
...
export const NoisbnReasonSchema = z.union([z.literal("archive_volume"), z.literal("monograph"), z.literal("simple_series")]);

export const StdAltAsPublishedReasonSchema = z.string();

export const PeerReviewRecommendationSchema = z.union([z.literal("major-revision"), z.literal("minor-revision"), z.literal("reject"), z.literal("reject-with-resubmit"), z.literal("accept"), z.literal("accept-with-reservation")]);

export const ReferenceDistributionOptsSchema = z.union([z.literal("none"), z.literal("query"), z.literal("any")]);
 ...
 * @maxLength 2048
 **/
export const ScnPolicyRefPrimitiveTypeSchema = z.string().min(1).max(2048).regex(/([hH][tT][tT][pP]|[hH][tT][tT][pP][sS]|[fF][tT][pP]):\/\/.*/);
...
export const PeerReviewStageSchema = z.union([z.literal("pre-publication"), z.literal("post-publication")]);
 ...
 * @maxLength 60
 **/
export const SurnamePrimitiveTypeSchema = z.string().min(1).max(60).regex(/[^\d\?]*[^\?\s]+[^\d]*/);
...
export const InstitutionIdTypeSchema = z.union([z.literal("ror"), z.literal("isni"), z.literal("wikidata")]);
 ...
 * withdrawal
 **/
export const CmUpdateTypeSchema = z.union([z.literal("addendum"), z.literal("clarification"), z.literal("correction"), z.literal("corrigendum"), z.literal("erratum"), z.literal("expression_of_concern"), z.literal("new_edition"), z.literal("new_version"), z.literal("partial_retraction"), z.literal("removal"), z.literal("retraction"), z.literal("withdrawal")]);

export const PeerReviewTypeSchema = z.union([z.literal("referee-report"), z.literal("editor-report"), z.literal("author-comment"), z.literal("community-comment"), z.literal("manuscript"), z.literal("aggregate"), z.literal("recommendation")]);

export const PostedContentTypeSchema = z.union([z.literal("preprint"), z.literal("working_paper"), z.literal("letter"), z.literal("dissertation"), z.literal("report"), z.literal("review"), z.literal("other")]);
...
export const HeadSchema = XastElementSchema.extend({
    type: z.literal("element"),
    name: z.literal("head"),
    children: z.array(z.union([DepositorSchema, DoiBatchIdSchema, RegistrantSchema, TimestampSchema]))
});
...
export const StringNameSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([DegreesSchema, GivenNameSchema, PrefixSchema, SuffixSchema, SurnameSchema]))
});
...
export const CrossmarkSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([CrossmarkDomainExclusiveSchema, CrossmarkDomainsSchema, CrossmarkPolicySchema, CrossmarkVersionSchema, CustomMetadataSchema, UpdatesSchema]))
});
...
export const InstitutionSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([InstitutionAcronymSchema, InstitutionDepartmentSchema, InstitutionIdSchema, InstitutionPlaceSchema]))
});
...
export const JournalMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([AbbrevTitleSchema, ArchiveLocationsSchema, CodenSchema, DoiDataSchema, FullTitleSchema, IssnSchema]))
});
...
export const JournalVolumeSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ArchiveLocationsSchema, DoiDataSchema, PublisherItemSchema, VolumeSchema]))
});
...
export const ProceedingsMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ArchiveLocationsSchema, DoiDataSchema, IsbnSchema, NoisbnSchema, ProceedingsSubjectSchema, ProceedingsTitleSchema, PublicationDateSchema, PublisherSchema, PublisherItemSchema]))
});
...
export const PersonNameSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([AffiliationsSchema, AltNameSchema, GivenNameSchema, ORCIDSchema, SuffixSchema, SurnameSchema]))
});
...
export const DatabaseMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ArchiveLocationsSchema, ContributorsSchema, DatabaseDateSchema, DescriptionSchema, DoiDataSchema, InstitutionSchema, rel.ProgramSchema, PublisherSchema, PublisherItemSchema, TitlesSchema]))
});
...
export const JournalIssueSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ArchiveLocationsSchema, ContributorsSchema, DoiDataSchema, IssueSchema, JournalVolumeSchema, PublicationDateSchema, SpecialNumberingSchema, TitlesSchema]))
});
...
export const PeerReviewSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([CompetingInterestStatementSchema, ContributorsSchema, DoiDataSchema, InstitutionSchema, ai.ProgramSchema, ReviewDateSchema, RunningNumberSchema, ScnPoliciesSchema, TitlesSchema]))
});
...
export const PendingPublicationSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([jats.AbstractSchema, AcceptanceDateSchema, ContributorsSchema, CrossmarkSchema, DoiSchema, InstitutionSchema, IntentStatementSchema, ItemNumberSchema, rel.ProgramSchema, PublicationSchema, TitlesSchema]))
});
...
export const PostedContentSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([jats.AbstractSchema, AcceptanceDateSchema, CitationListSchema, ContributorsSchema, DoiDataSchema, GroupTitleSchema, InstitutionSchema, ItemNumberSchema, PostedDateSchema, fr.ProgramSchema, ScnPoliciesSchema, TitlesSchema]))
});
...
export const ReportPaperMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([jats.AbstractSchema, ApprovalDateSchema, ArchiveLocationsSchema, CitationListSchema, ContractNumberSchema, ContributorsSchema, CrossmarkSchema, DoiDataSchema, EditionNumberSchema, InstitutionSchema, IsbnSchema, rel.ProgramSchema, PublicationDateSchema, PublisherSchema, PublisherItemSchema, ScnPoliciesSchema, TitlesSchema]))
});
...
export const SeriesMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([jats.AbstractSchema, ArchiveLocationsSchema, CodenSchema, ContributorsSchema, CrossmarkSchema, DoiDataSchema, IssnSchema, PublisherItemSchema, SeriesNumberSchema, TitlesSchema]))
});
...
export const SetMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ArchiveLocationsSchema, ContributorsSchema, DoiDataSchema, IsbnSchema, NoisbnSchema, PartNumberSchema, PublisherItemSchema, TitlesSchema]))
});
...
export const StandardMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([jats.AbstractSchema, ApprovalDateSchema, ArchiveLocationsSchema, CitationListSchema, ContributorsSchema, CrossmarkSchema, DesignatorsSchema, DoiDataSchema, EditionNumberSchema, IsbnSchema, rel.ProgramSchema, PublisherSchema, PublisherItemSchema, StandardsBodySchema, TitlesSchema]))
});
...
export const BookMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([jats.AbstractSchema, AcceptanceDateSchema, ArchiveLocationsSchema, CitationListSchema, ContributorsSchema, CrossmarkSchema, DoiDataSchema, EditionNumberSchema, IsbnSchema, NoisbnSchema, rel.ProgramSchema, PublicationDateSchema, PublisherSchema, PublisherItemSchema, TitlesSchema]))
});
...
export const BookSeriesMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ArchiveLocationsSchema, CitationListSchema, CrossmarkSchema, DoiDataSchema, rel.ProgramSchema, PublicationDateSchema, PublisherSchema, PublisherItemSchema, SeriesMetadataSchema]))
});
...
export const BookSetMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ArchiveLocationsSchema, CitationListSchema, ContributorsSchema, CrossmarkSchema, DoiDataSchema, EditionNumberSchema, IsbnSchema, NoisbnSchema, rel.ProgramSchema, PublicationDateSchema, PublisherSchema, PublisherItemSchema, SetMetadataSchema, VolumeSchema]))
});
...
export const ComponentSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ContributorsSchema, DescriptionSchema, DoiSchema, DoiDataSchema, FormatSchema, ai.ProgramSchema, PublicationDateSchema, TitlesSchema]))
});
...
export const ConferencePaperSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([jats.AbstractSchema, AcceptanceDateSchema, ArchiveLocationsSchema, CitationListSchema, ComponentListSchema, ContributorsSchema, CrossmarkSchema, DoiDataSchema, PagesSchema, rel.ProgramSchema, PublicationDateSchema, PublisherItemSchema, ScnPoliciesSchema, TitlesSchema]))
});
...
export const ContentItemSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([jats.AbstractSchema, AcceptanceDateSchema, ArchiveLocationsSchema, CitationListSchema, ComponentListSchema, ComponentNumberSchema, ContributorsSchema, CrossmarkSchema, DoiDataSchema, PagesSchema, rel.ProgramSchema, PublicationDateSchema, PublisherItemSchema, ScnPoliciesSchema, TitlesSchema]))
});
...
export const DatasetSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ArchiveLocationsSchema, CitationListSchema, ComponentListSchema, ContributorsSchema, CrossmarkSchema, DatabaseDateSchema, DescriptionSchema, DoiDataSchema, FormatSchema, rel.ProgramSchema, PublisherItemSchema, TitlesSchema]))
});
...
export const DissertationSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([jats.AbstractSchema, ApprovalDateSchema, ArchiveLocationsSchema, CitationListSchema, ComponentListSchema, ContributorsSchema, CrossmarkSchema, DegreeSchema, DoiDataSchema, InstitutionSchema, IsbnSchema, PersonNameSchema, rel.ProgramSchema, PublisherItemSchema, ScnPoliciesSchema, TitlesSchema]))
});
...
export const ProceedingsSeriesMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ArchiveLocationsSchema, DoiDataSchema, PublisherItemSchema, SeriesMetadataSchema]))
});
...
export const ReportPaperSeriesMetadataSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ApprovalDateSchema, ArchiveLocationsSchema, CitationListSchema, ContractNumberSchema, ContributorsSchema, DoiDataSchema, EditionNumberSchema, InstitutionSchema, IsbnSchema, rel.ProgramSchema, PublicationDateSchema, PublisherSchema, PublisherItemSchema, SeriesMetadataSchema, VolumeSchema]))
});
...
export const BookSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([BookMetadataSchema, BookSeriesMetadataSchema, BookSetMetadataSchema, ContentItemSchema]))
});
...
export const ConferenceSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ConferencePaperSchema, ContributorsSchema, EventMetadataSchema, ProceedingsMetadataSchema, ProceedingsSeriesMetadataSchema]))
});
...
export const ReportPaperSchema = XastElementSchema.extend({
    ...
    children: z.array(z.union([ComponentListSchema, ContentItemSchema, ReportPaperMetadataSchema, ReportPaperSeriesMetadataSchema]))
});
...
export const BodySchema = XastElementSchema.extend({
    type: z.literal("element"),
    name: z.literal("body"),
    children: z.array(z.union([BookSchema, ConferenceSchema, DatabaseSchema, DissertationSchema, JournalSchema, PeerReviewSchema, PendingPublicationSchema, PostedContentSchema, ReportPaperSchema, SaComponentSchema, StandardSchema]))
});
