...
export const AssertionNameSchema = z.union([z.literal("fundgroup"), z.literal("funder_identifier"), z.literal("funder_name"), z.literal("award_number")]);
 ...
 **/
export const AssertionSchema: z.ZodSchema<Assertion> = z.lazy(() => XastElementSchema.extend({
    type: z.literal("element"),
