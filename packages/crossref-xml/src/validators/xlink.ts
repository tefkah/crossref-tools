...
export const ActuateSchema = z.union([z.literal("onLoad"), z.literal("onRequest"), z.literal("other"), z.literal("none")]);
...
export const ShowSchema = z.union([z.literal("new"), z.literal("replace"), z.literal("embed"), z.literal("other"), z.literal("none")]);
...
export const TypeSchema = z.union([z.literal("simple"), z.literal("extended"), z.literal("locator"), z.literal("arc"), z.literal("resource"), z.literal("title"), z.literal("none")]);
